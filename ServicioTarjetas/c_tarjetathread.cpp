...
void c_TarjetaThread::run()
{
    ...
    if(Function==0){
        ...
        emit LecturaTarjeta(100); //Función lectura normal
   ...
   /* else if (Function ==39)
    ...
    {
        emit LecturaTarjeta(53);// 53-> Función Identificador Tarjeta
    }
    else
    {
        emit LecturaTarjeta(100);//Funcion lectura normal por defecto
    }
}
